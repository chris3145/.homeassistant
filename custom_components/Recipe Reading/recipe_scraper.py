...
urls.append("http://allrecipes.com/recipe/222085/healthier-delicious-ham-and-potato-soup/?internalSource=staff%20pick&referringId=1552&referringContentType=recipe%20hub&clickId=cardslot%205")   # All of the ingredients are there, but I find extra junk too (though it should be easy to ignore)
...
for ndx, member in enumerate(urls): 
    ...
    print("Saving", urls[ndx], "to", recipeFile)
